...
public:
	CWiderstand();
	~CWiderstand();
	CWiderstand(double _wertR, double _Preis, double _x, double _y);
	
	// Diklarerern
	void Ausgabe() const;
	void Eingabe(double _wertR, double _Preis, double _x, double _y);
/*
	// virtual 
...
*/
	...
	double getImaginaerteil(double _f) const; // Zl(f)   ::   XL
